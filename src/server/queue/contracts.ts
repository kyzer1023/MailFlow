...
export type TickResult =
  ...
  | { kind: "waiting"; campaignId: string; jobId: string | null; reason: MailboxUnavailableReason | "not_due" | "attachments_temporarily_unavailable"; nextAttemptAt: string; delaySeconds: number }
